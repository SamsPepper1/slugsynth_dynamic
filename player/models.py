...
class Player(models.Model):
	...
	def getStarterPallette(self):
		...
		slug3.save()
		sound3 = Sound(waveForm = 'sine', amp=0.2, overTones = randomOvertones(0.5,4,3), noise=0,slug=slug3)
		sound3.save()
		...
		slug4.save()
		sound4 = Sound(waveForm = 'sine', amp=0.15, overTones = randomOvertones(4,0.5,3), noise=0,slug=slug4)
		sound4.save()
