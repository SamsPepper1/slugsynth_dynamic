...
class Player(models.Model):
	...
	def getStarterPallette(self):
		...
		shape1 = Shape(attack=0.01, decay= 0.01, sustainLevel=0.8, sustainLengthDefault=1, release=0.4,shape=DEFAULT_SLUG_PATH, name='shape', last_used = datetime.now())
		shape1.save()
		slug1 = Slug(owner = self, name="Terry", birthday = datetime.now(), color = random.randint(0,180))
		slug1.save()
		...
		shape2 = Shape(attack=0.01, decay= 0.01, sustainLevel=0.8, sustainLengthDefault=1, release=0.4,shape=DEFAULT_SLUG_PATH, name='shape', last_used = datetime.now())
		shape2.save()
		slug2 = Slug(owner = self, name="B-alf", birthday = datetime.now(), color = random.randint(0,180))
		slug2.save()
		...
		shape3 = Shape(attack=0.01, decay= 0.01, sustainLevel=0.8, sustainLengthDefault=1, release=0.4,shape=DEFAULT_SLUG_PATH, name='shape', last_used = datetime.now())
		shape3.save()
		slug3 = Slug(owner = self, name="T'Norkhton", birthday = datetime.now(), color = random.randint(0,180))
		slug3.save()
		...
		shape4 = Shape(attack=0.01, decay= 0.01, sustainLevel=0.8, sustainLengthDefault=1, release=0.4,shape=DEFAULT_SLUG_PATH, name='shape', last_used = datetime.now())
		shape4.save()
		slug4 = Slug(owner = self, name="Bliffle", birthday = datetime.now(), color = random.randint(0,180))
		slug4.save()
